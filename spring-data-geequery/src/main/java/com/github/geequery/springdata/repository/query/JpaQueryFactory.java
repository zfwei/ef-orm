...
/**
 * Factory to create the appropriate {@link RepositoryQuery} for a
 * {@link JpaQueryMethod}.
 * 
...
enum JpaQueryFactory {
	 ...
	 * is potentially annotated with {@link Query}.
	 * 
	 * @param method
	 ...
	 */
	Query fromQueryAnnotation(GqQueryMethod method, EntityManager em, EvaluationContextProvider evaluationContextProvider) {
	 ...
	 * @return
	 */
	Query fromMethodWithQueryString(GqQueryMethod method, EntityManager em, String queryString, EvaluationContextProvider evaluationContextProvider) {
		boolean isNative=method.isNativeQuery();
		if (queryString == null) {
			return null;
		}
		return null;
	...
	/**
	 * Creates a {@link StoredProcedureJpaQuery} from the given
	 * {@link JpaQueryMethod} query.
	 * 
	 * @param method
	 *            must not be {@literal null}.
	 * @param em
	 ...
	 * @return
	 */
	public Query fromProcedureAnnotation(GqQueryMethod method, EntityManager em) {
