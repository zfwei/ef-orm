...
//	 * @param provider must not be {@literal null}.
//	 */
//	public ParameterMetadataProvider(Parameters<?, ?> parameters, PersistenceProvider provider) {
...
//		 * @param provider
//		 */
//		public ParameterMetadata(String expression, Type type, Object value, PersistenceProvider provider) {
