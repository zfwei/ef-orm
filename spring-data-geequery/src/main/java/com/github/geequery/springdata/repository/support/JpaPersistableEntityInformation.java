...
public class JpaPersistableEntityInformation<T extends Persistable<ID>, ID extends Serializable> extends
	 ...
	 */
	public JpaPersistableEntityInformation(Class<T> domainClass, MetaProvider metamodel) {
		super(domainClass, metamodel);
	}

	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.support.JpaMetamodelEntityInformation#isNew(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.support.JpaMetamodelEntityInformation#getId(java.lang.Object)
	 */
	@Override
