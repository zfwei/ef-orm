...
public final class JpaQueryLookupStrategy {
	...
	private static class DeclaredQueryLookupStrategy extends AbstractQueryLookupStrategy {
		...
		/*
		 * (non-Javadoc)
		 * @see com.github.geequery.springdata.repository.query.JpaQueryLookupStrategy.AbstractQueryLookupStrategy#resolveQuery(com.github.geequery.springdata.repository.query.JpaQueryMethod, javax.persistence.EntityManager, org.springframework.data.repository.core.NamedQueries)
		 */
		@Override
		protected RepositoryQuery resolveQuery(JpaQueryMethod method, EntityManager em, NamedQueries namedQueries) {
	 ...
	 * {@link com.github.geequery.springdata.repository.Query}, JPA named query). In case none is found we fall back on
	 * query creation.
	 * 
	 * @author Oliver Gierke
	 * @author Thomas Darimont
