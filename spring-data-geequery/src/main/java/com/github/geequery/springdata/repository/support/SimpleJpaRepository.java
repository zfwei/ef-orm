...
import static com.github.geequery.springdata.repository.query.QueryUtils.COUNT_QUERY_STRING;
import static com.github.geequery.springdata.repository.query.QueryUtils.DELETE_ALL_QUERY_STRING;
import static com.github.geequery.springdata.repository.query.QueryUtils.applyAndBind;
import static com.github.geequery.springdata.repository.query.QueryUtils.getQueryString;
import static com.github.geequery.springdata.repository.query.QueryUtils.toOrders;
...
import com.github.geequery.springdata.repository.query.Jpa21Utils;
import com.github.geequery.springdata.repository.query.JpaEntityGraph;
...
public class SimpleJpaRepository<T, ID extends Serializable>
	 ...
	 */
	public SimpleJpaRepository(JpaEntityInformation<T, ?> entityInformation, JefEntityManagerFactory entityManager) {
	 ...
	 */
	public SimpleJpaRepository(Class<T> domainClass, JefEntityManagerFactory em) {
	 ...
	 * @return
	 */
	protected final JefEntityManager getEntityManager(){
		TransactionMode tx=emf.getDefault().getTxType();
		JefEntityManager em;
		switch (tx) {
		case JPA:
		case JTA:
			em=(JefEntityManager) EntityManagerFactoryUtils.doGetTransactionalEntityManager(emf,null);
			if(em==null){ //当无事务时。Spring返回null
				em=(JefEntityManager) emf.createEntityManager(null,Collections.EMPTY_MAP);
			}	
			break;
		case JDBC:
			ConnectionHolder conn=(ConnectionHolder)TransactionSynchronizationManager.getResource(emf.getDefault().getDataSource());
			if(conn==null){//基于数据源的Spring事务
				em=(JefEntityManager) emf.createEntityManager(null,Collections.EMPTY_MAP);
			}else{
				ManagedTransactionImpl session=new ManagedTransactionImpl(emf.getDefault(),conn.getConnection());
				em= new JefEntityManager(emf,null,session);
			}
			break;
		default:
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#deleteInBatch(java.lang.Iterable)
	 */
	@Transactional
	public void deleteInBatch(Iterable<T> entities) {
		...
		getEntityManager().getSession().batchDelete(CollectionUtils.toList(entities));
	...
	/* 
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#deleteAllInBatch()
	 */
	@Transactional
	...
	/* 
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#getOne(java.io.Serializable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#findAll()
	 */
	public List<T> findAll() {
		
		
		
		JefEntityManagerFactory jefEmf=em.getEntityManagerFactory().getClass()
		...
		//此处可能有事务，需要从EM上出发。不能完全脱离EM，应该事务是位于EM上的
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#findAll(org.springframework.data.domain.Sort)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaSpecificationExecutor#findOne(com.github.geequery.springdata.domain.Specification)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaSpecificationExecutor#findAll(com.github.geequery.springdata.domain.Specification)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaSpecificationExecutor#findAll(com.github.geequery.springdata.domain.Specification, org.springframework.data.domain.Pageable)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaSpecificationExecutor#findAll(com.github.geequery.springdata.domain.Specification, org.springframework.data.domain.Sort)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaSpecificationExecutor#count(com.github.geequery.springdata.domain.Specification)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#saveAndFlush(java.lang.Object)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#save(java.lang.Iterable)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.JpaRepository#flush()
	 */
	@Transactional
	public void flush() {
