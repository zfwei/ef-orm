...
import static com.github.geequery.springdata.domain.Specifications.CompositionType.*;
...
public class Specifications<T> implements Specification<T>, Serializable {
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.domain.Specification#toPredicate(javax.persistence.criteria.Root, javax.persistence.criteria.CriteriaQuery, javax.persistence.criteria.CriteriaBuilder)
	 */
