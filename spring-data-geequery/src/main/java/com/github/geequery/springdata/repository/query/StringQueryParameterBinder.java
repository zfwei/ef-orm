...
import com.github.geequery.springdata.repository.query.StringQuery.LikeParameterBinding;
import com.github.geequery.springdata.repository.query.StringQuery.ParameterBinding;
...
public class StringQueryParameterBinder extends ParameterBinder {
	...
	/* 
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.query.ParameterBinder#bind(javax.persistence.Query, org.springframework.data.repository.query.Parameter, java.lang.Object, int)
	 */
	@Override
