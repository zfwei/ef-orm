...
// */
//package com.github.geequery.springdata.repository.cdi;
//
...
//
//import com.github.geequery.springdata.repository.support.JpaRepositoryFactory;
//
///**
...
//
//	private final Bean<EntityManagerFactory> entityManagerBean;
//
//	/**
...
//	 */
//	JpaRepositoryBean(BeanManager beanManager, Bean<EntityManagerFactory> entityManagerBean, Set<Annotation> qualifiers,
...
//		EntityManagerFactory entityManager = getDependencyInstance(entityManagerBean, EntityManagerFactory.class);
//
//		// Create the JPA repository instance and return it.
//		JpaRepositoryFactory factory = new JpaRepositoryFactory((JefEntityManagerFactory)entityManager);
