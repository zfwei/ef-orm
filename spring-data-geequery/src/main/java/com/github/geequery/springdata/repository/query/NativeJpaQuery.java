 ...
 * for the existence of an {@link com.github.geequery.springdata.repository.Query} annotation and creates a JPA native
 * {@link Query} from it.
 * 
...
final class NativeJpaQuery extends AbstractStringBasedJpaQuery {
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.springdata.repository.query.AbstractStringBasedJpaQuery#createJpaQuery(java.lang.String)
	 */
	@Override
