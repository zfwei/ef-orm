...
public abstract class JpaQueryExecution {
	...
	static class SlicedExecution extends JpaQueryExecution {
		...
		/* 
		 * (non-Javadoc)
		 * @see com.github.geequery.springdata.repository.query.JpaQueryExecution#doExecute(com.github.geequery.springdata.repository.query.AbstractJpaQuery, java.lang.Object[])
		 */
		@Override
